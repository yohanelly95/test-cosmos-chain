...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdf92e9399f62827, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cdf92e9399f62827, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "razorchain.razorchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "razorchain.razorchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("razorchain/razorchain/tx.proto", fileDescriptor_cdf92e9399f62827) }

var fileDescriptor_cdf92e9399f62827 = []byte{
	// 323 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x2b, 0x4a, 0xac, 0xca,
	0x2f, 0x4a, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x8f, 0xe5, 0x18, 0xa2, 0x64, 0xc1, 0x86, 0x38, 0x63, 0xfa, 0xa9, 0xa4, 0xb2, 0x20, 0xb5, 0x38,
	0x89, 0x0d, 0x1c, 0x35, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd8, 0x07, 0x70, 0xdc, 0x54,
	0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/razorchain.razorchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/razorchain.razorchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "razorchain.razorchain.Msg",
	...
	Metadata: "razorchain/razorchain/tx.proto",
}
